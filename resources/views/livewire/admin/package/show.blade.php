    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9 col-form-label">
            <div class="introductory-video">
                <div class="box-video">
                    <div class="bg-video" style="background-image: url({{ $details->image_url }});">
                        <div class="bt-play">
                    ...
                    <div class="video-container">
                        <video controls="" width="450" height="315" preload="none" poster="{{ $details->image_url }}" id="clip-video"  playsinline>
