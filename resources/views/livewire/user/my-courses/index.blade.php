    ...
    <div class="col-md-12 grid-margin">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-5 col-sm-12">
                ...
                <div class="plan-name">Standard Package</div>
                <div class="course-price-list">
                    ...
                    <li>
                        ...
                        <div class="details-course">450</div>
                    </li>
                    <li>
                        <div class="name-list">
            ...
            <div class="col-lg-12 col-sm-12">
                ...
                <div class="course-item">
                    ...
                    <div class="course-text-width">
                        <h5 class="head-f-25 color-dark-blue">How To Become A Successful Affiliate Marketer</h5>
                        <div class="content">
                        <p>Influencing traffic to buy your products or services comes with a promise of quality of content to learn specific.</p>
                        </div>
                    </div>
                ...
                <div class="course-item">
                    ...
                    <div class="course-text">
                    <div class="course-text-width">
                        <h5 class="head-f-25 color-dark-blue">Webinar Topic Title Here</h5>
                        <div class="content">
                        <p>Influencing traffic to buy your products or services comes with a promise of quality of content to learn specific.</p>
                        </div>
                    </div>
