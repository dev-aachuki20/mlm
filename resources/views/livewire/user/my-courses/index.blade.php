                        ...
                        <div class="col-lg-7 col-sm-12">
                            <div class="my-course-video-main">
                                <video id='video' controls="controls" preload='none' width="600" poster="{{$packageDetail->image_url}}">
                                    <source id='mp4' src="{{$packageDetail->video_url}}" type='video/mp4' />
                                    </track>
                                </video>
                            </div>
                            <div class="sec-head">
                                ...
                                <div class="course-item">
                                        ...
                                        <div class="box-video">
                                          <!--  <div class="bg-video" style="background-image: url({{ asset('images/package.png') }});">
                                            ...
                                            <div class="video-container">
                                                ...
                                                <video class='video-container' controls="controls" preload='none' width="560" height="315" poster="{{$lecture->course_image_url}}">
                                                    <source id='' src="{{$lecture->course_video_url}}" type='video/mp4' />
                                                    </track>
                                                </video>
                                            </div>
                                    ...
                                    <div class="course-text">
                                        <div class="course-text-width">
                                            <h5 class="head-f-25 color-dark-blue">{{$lecture->title}}</h5>
                                            <div class="content">
